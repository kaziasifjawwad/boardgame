...
public class GameTest implements CommandLineRunner {
    ...
    public void run(String... args) {
        UserProfile firstProfile = new UserProfile().setName("Pol").setAge(10);
        UserProfile secondProfile = new UserProfile().setName("Tom").setAge(20);
        UserProfile thirdProfile = new UserProfile().setName("Bob").setAge(40);
